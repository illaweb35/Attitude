 ...
 */
final class Version20220323100204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, image_caption VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL)');
